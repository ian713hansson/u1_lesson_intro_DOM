...
DOM Manipulation is how we are going to use our JS to control our HTML and CSS. It is going to be one of the most important concepts we learn in this class, and something that we will be working with every week from here on in.
